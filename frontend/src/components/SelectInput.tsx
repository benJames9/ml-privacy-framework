...
const SelectInput: React.FC<SelectInputProps> = ({ label, options, onChange, isRequired = false }) => {
  return (
    <div className="flex mt-4 justify-between items-center">
      ...
      <select
        onChange={onChange}
        className="w-[202px] text-black font-semibold bg-gray-300 border border-gray-500 rounded-md py-2 px-3 focus:ring-blue-500 focus:border-blue-500 sm:text-sm "
      >
